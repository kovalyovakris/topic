...
namespace тема2
{
    partial class Topic4Test2
    {
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Topic4Test2));
			...
			label1.Name = "label1";
			label1.Size = new Size(615, 49);
			label1.TabIndex = 20;
			label1.Text = "Тест№2: мотивация сотрудников";
			// 
			// roundedPanel1
			// 
			...
			roundedPanel1.Location = new Point(153, 68);
			...
			roundedPanel9.Location = new Point(913, 68);
			...
			roundedPanel8.Location = new Point(817, 68);
			...
			roundedPanel7.Location = new Point(723, 68);
			...
			roundedPanel6.Location = new Point(627, 68);
			...
			roundedPanel5.Location = new Point(533, 68);
			...
			roundedPanel4.Location = new Point(439, 68);
			...
			roundedPanel2.Location = new Point(249, 68);
			...
			roundedPanel3.Location = new Point(343, 68);
