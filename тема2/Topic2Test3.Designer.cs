...
namespace тема2
{
    partial class Topic2Test3
    {
		...
		private void InitializeComponent()
		{
			...
			radioButton3.Location = new Point(58, 369);
			...
			label1.TabIndex = 14;
			label1.Text = "Тест №3: отбор персонала в IT-сфере";
			// 
			// pictureBox1
			// 
