...
namespace тема2
{
    public partial class Topic7Test1 : Form
    {
        ...
        private String[] questions = new string[10] {
                ...
                "Какой первый шаг следует предпринять при обнаружении проб-\n" +
                "лем с производительностью сотрудника?",
                ...
                "Как следует поступать, если сотрудник неадекватно реагиру-\n" + 
                "ет на конструктивную критику?",
        ...
        private String[] answer1 = new string[10] {
            ...
            "Позитивный климат не имеет большого значения, если сотру-\n" +
            "дник нарушает правила",
