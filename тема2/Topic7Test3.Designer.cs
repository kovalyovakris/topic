...
namespace тема2
{
    partial class Topic7Test3
    {
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Topic7Test3));
			...
			label1.Location = new Point(495, 46);
			label1.Margin = new Padding(5, 0, 5, 0);
			label1.Name = "label1";
			label1.Size = new Size(770, 49);
			label1.TabIndex = 56;
			label1.Text = "Тест№3: cоздание эффективной команды";
			// 
			// roundedPanel1
			// 
			...
			Text = "Создание эффективной команды";
