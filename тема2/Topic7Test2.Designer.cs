...
namespace тема2
{
    partial class Topic7Test2
    {
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Topic7Test2));
			...
			label1.TabIndex = 47;
			label1.Text = "Тест№2: cоздание эффективной команды";
			// 
			// roundedPanel1
			// 
