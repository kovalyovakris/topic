...
namespace тема2
{
    partial class Topic2Test2
    {
		...
		private void InitializeComponent()
		{
			...
			groupBox1.Location = new Point(288, 163);
			...
			radioButton2.Location = new Point(58, 301);
			...
			radioButton1.Location = new Point(58, 230);
			...
			label1.Location = new Point(547, 51);
			label1.Margin = new Padding(5, 0, 5, 0);
			label1.Name = "label1";
			label1.Size = new Size(695, 49);
			label1.TabIndex = 11;
