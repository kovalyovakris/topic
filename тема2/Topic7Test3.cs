...
namespace тема2
{
    public partial class Topic7Test3 : Form
    {
        ...
        private String[] answer1 = new string[10] {
            ...
            "Оставить разногласия нерешенными и надеяться,\n"+"что они решатся сами собой",
            "Оставить цели открытыми и полагаться на\n"+"индивидуальные интерпретации",
        ...
        private String[] answer2 = new string[10] {
            ...
            "Использовать данные по завершенным проектам и удовлетворенности\n"+"клиентов для оценки эффективности",
        };
        private String[] answer3 = new string[10] {
            ...
            "Учитывать профессиональные навыки и интересы сотрудников\n"+"при распределении задач, чтобы повысить эффективность выполнения",
        ...
        private void ShowAnswer(int p)
        {
            ...
            if (points <= 6)
            {
                ...
                "для развития эффективных методов взаимодействия и управления";
            }
            ...
            else if (points >= 17 && points <= 20)
            {
                ...
                "эффективной командой, применяя продуманные стратегии и методы";
            }
        }
