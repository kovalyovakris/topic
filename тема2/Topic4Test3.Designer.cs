...
namespace тема2
{
    partial class Topic4Test3
    {
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Topic4Test3));
			...
			Button1.Location = new Point(733, 301);
			...
			label1.TabIndex = 32;
			label1.Text = "Тест№3: мотивация сотрудников";
			// 
			// roundedPanel1
			// 
